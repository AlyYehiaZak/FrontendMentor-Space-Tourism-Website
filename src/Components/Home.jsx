                ...
                <div className="home_container">
                    ...
                    <div className="row w-100">
                        ...
                        <div className="col-12 col-lg-6 d-flex flex-column align-items-center p-0">
                            <p className="myFontFamily fs-4 home_paragraph">SO, YOU WANT TO TRAVEL TO</p>
                            <p className="myFontFamily home_title text-white">SPACE</p>
                            <p className="myFontFamily2 home_paragraph home_paragraph2">Lets face it, if you want to go to space, you might as well genuinely go to outer space and not hover kind of on the edge of it. Well sit back, and relax because we'll give you a truly out of this world experience!</p>
                        </div>
